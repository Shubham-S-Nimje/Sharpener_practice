...
function getData() {
  axios.all([
  axios.get('https://jsonplaceholder.typicode.com/todos/1?_limit=5'),
...
const axiosinstence = axios.create({
  //other cstom settings
  baseURL: 'https://jsonplaceholder.typicode.com'
});
// axiosinstence.get('/comments').then(res => showOutput(res));
